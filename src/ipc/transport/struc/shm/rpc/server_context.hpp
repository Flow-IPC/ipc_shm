...
protected:
   ...
   *        For Session_vat_network ctor (see its doc header; briefly: pre-connected stream-socket handle,
   *        as sent to us by the opposing Client_context or equivalent; subsumed and nullified by this ctor).
